...
<html lang="pt-br">
  ...
  <body background="Imagens/Back.jpg"">
	...
	<div class="container">	
	<center> <h1> Alterar formulário de agendamento </h1></center>

	<div class="row" style="margin-top: -50px;">	
		<div class="col-12"> 
			<a href="ListarFormulario.php" class="btn btn-outline-dark float-right" >Voltar</a>
		</div>
	</div>
	
	<center> <h3> Deverá ser inserido, obrigatoriamente, o sexo e o motivo da solicitação. </h3> </center>
...
<?php	
	...
	?>
		<p> <center> <form action="RealizarAltFormulario.php" method="POST">
...
<br>
		  ...
		  <div class="form-group">
		   <div class=col-5>
			<label for="exampleFormControlSelect1">Motivo do agendamento</label>
			<select class="form-control" name="motivoa" id="exampleFormControlSelect1">
...
<br>
		  ...
		  <div class="form-group">
		   <div class=col-5>
			<label for="exampleFormControlSelect1">Data para agendamento: </label>
			<input type="date" name="da" class="form-control" value="<?php echo $row['da']; ?>">
			</select>
		  </div>		  
<br>	  
		  ...
		  <div class="form-group">
		   <div class=col-5>
			<label for="exampleFormControlTextarea1">Mensagem para os advogados: </label>
			<input value="<?php echo $row['mensagem']; ?>"textarea class="form-control" name="mensagem" id="exampleFormControlTextarea1" rows="3" ></textarea>
		  </div>
<br>
