...
$email= $_POST['email'];
$proces= $_POST['proces'];
$sql = "insert into cliente(nome,sexo,cpf,datanasc,tel,email,proces)

values('$nome','$sexo','$cpf','$datanasc','$tel','$email','$proces')";
...
if (mysqli_connect_errno()){ 
	...
	echo "<br> <center><h2> Cadastro de cliente efetuado com
	sucesso!</center></h2><p><br>";
	mysqli_close($con);
?>

<center> <a href="ListarCliente.php" class="btn btn-outline-dark" >Voltar</a> </center>