...
<div class="container-fluid">
		<div class="row" style="margin-top: 30px;">
			<div class="col-8">	
				...
				<div class="col-4"> 
					<a href="Funcionario.html" class="btn btn-success float-right" >Novo Funcionario</a>
				</div>
		</div>
...
<?php
	...
	$result=mysqli_query($con,"SELECT*FROM funcionario");?> <p> <center>
  ...
  <tr>
	...
	<td> <?php echo $row['admi'];?> </td>
	<td> <?php echo $row['oab'];?> </td>
		<td>
			<form action="DeletarFuncionario.php" method="POST">
