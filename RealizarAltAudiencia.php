...
$nomeadv= $_POST['nomeadv'];
$telefoneadv=$_POST['telefoneadv'];
$motaud= $_POST['motaud'];
$dataaud= $_POST['dataaud'];
$nomejuiz= $_POST['nomejuiz'];	
	
		$sql=("update audiencia set 
		id='$id',nomeclie='$nomeclie',telefonecli='$telefonecli',nomeadv='$nomeadv',telefoneadv='$telefoneadv',motaud='$motaud',dataaud='$dataaud',nomejuiz='$nomejuiz' where id=$id");
        $con=mysqli_connect("127.0.0.1","root","","projetoadvocacia");
			...
			if (mysqli_connect_errno()){  
				...
				echo "<center> <h2> Audiência alterada com sucesso! </center> </h2> <p> <br>";                
				mysqli_close($con);		
	?> 
              <center> <h2> <a class="btn btn-outline-dark" href="ListarAudiencia.php">VOLTAR</a> </h2> </center>
