...
<?php	
    ...
    $proces=$_POST['proces'];                	
		...
		id='$id',nome='$nome',sexo='$sexo',cpf='$cpf',datanasc='$datanasc',tel='$tel',email='$email',proces='$proces' where id=$id");
        $con=mysqli_connect("127.0.0.1","root","","projetoadvocacia");
			...
			if (mysqli_connect_errno()){  
				...
				echo "<center> <h2> Cliente alterado(a) com sucesso! </center> </h2> <p> <br>";                
				mysqli_close($con);		
	?> 
              <center> <h2> <a class="btn btn-outline-dark" href="ListarCliente.php">VOLTAR</a> </h2> </center>
