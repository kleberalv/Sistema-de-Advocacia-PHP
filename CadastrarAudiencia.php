...
$sql = "insert into audiencia(nomeclie,telefonecli,nomeadv,telefoneadv,motaud,dataaud,nomejuiz)

values('$nomeclie','$telefonecli','$nomeadv','$telefoneadv','$motaud','$dataaud','$nomejuiz')";
...
if (mysqli_connect_errno()){ 
	...
	echo "<br> <center><h2> Audiência marcada com sucesso! </center></h2><p><br>";
	mysqli_close($con);
?>

<center> <a href="ListarAudiencia.php" class="btn btn-outline-dark" >Voltar</a> </center>