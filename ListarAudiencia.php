...
<div class="container-fluid">
		<div class="row" style="margin-top: 30px;">
			<div class="col-8">	
				...
				<div class="col-4"> 
					<a href="Audiencia.php" class="btn btn-success float-right" >Nova Audiência</a>
				</div>
		</div>
...
<?php
	...
	$result=mysqli_query($con,"SELECT*FROM audiencia");?> <p> <center>
	...
	<tr> 
		...
		<th scope="col"> |Telefone do advogado| </th>
		<th scope="col"> |Motivo da Audiência| </th>
  ...
  <tr> 
	...
	<td> <?php echo $row['nomeclie'];?> </td>
	<td> <?php echo $row['telefonecli'];?> </td>
	<td> <?php echo $row['nomeadv'];?> </td>
	<td> <?php echo $row['telefoneadv'];?> </td>
	<td> <?php echo $row['motaud'];?> </td>
	<td> <?php echo $row['dataaud'];?> </td>
	<td> <?php echo $row['nomejuiz'];?> </td>
		<td>
			<form action="DeletarAudiencia.php" method="POST">
			<input type="hidden" name="id" value="<?php echo $row['id'];?>"/>			
			<button class="btn btn-outline-danger" type="submit" name="botdelpform" value="ok">DELETAR</button>	
			</form> </td>
			
			<td> 
				<form action="AlterarAudiencia.php" method="POST">
				<input type="hidden" name="id" value="<?php echo $row['id'];?>"/>
				<button class="btn btn-outline-primary" type="submit" name="botaltform" value="ok">ALTERAR</button>
