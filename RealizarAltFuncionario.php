...
<?php	
    ...
    $oab=$_POST['oab'];	
		...
		id='$id',nome='$nome',sexo='$sexo',cpf='$cpf',datanasc='$datanasc',tel='$tel',email='$email',area='$area',admi='$admi',oab='$oab' where id=$id");
        $con=mysqli_connect("127.0.0.1","root","","projetoadvocacia");
			...
			if (mysqli_connect_errno()){  
				...
				echo "<center> <h2> Funcionário alterado(a) com sucesso! </center> </h2> <p> <br>";                
				mysqli_close($con);		
	?> 
              <center> <h2> <a class="btn btn-outline-dark" href="ListarFuncionarios.php">VOLTAR</a> </h2> </center>
