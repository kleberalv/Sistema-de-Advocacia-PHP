...
<div class="container">	
			<center> <h1> Formulário de alteração de Clientes </h1> </center>

	<div class="row" style="margin-top: -50px;">	
		<div class="col-11"> 
			<a href="ListarCLiente.php" class="btn btn-outline-dark float-right" >Voltar</a>
		</div>
	</div>
	
	<center> <h3> Deverá ser inserido obrigatoriamente o sexo e o processo cadastrado. </h3> </center>
...
<?php	
	...
	?>
		<p> <center> <form action="RealizarAltCLiente.php" method="POST">
...
<br>
		  ...
		  <div class="form-group">
		   <div class=col-5>
			<label for="exampleFormControlSelect1">Tipo de processo cadastrado: </label>
			<select class="form-control" name="proces" id="exampleFormControlSelect1">
