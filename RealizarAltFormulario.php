...
<?php	
    ...
    $mensagem=$_POST['mensagem'];	
		...
		id='$id',nome='$nome',sexo='$sexo',tel='$tel',email='$email',motivoa='$motivoa',da='$da',mensagem='$mensagem' where id=$id");
        $con=mysqli_connect("127.0.0.1","root","","projetoadvocacia");
			...
			if (mysqli_connect_errno()){  
				...
				echo "<center> <h2> Reunião alterada com sucesso! </center> </h2> <p> <br>";                
				mysqli_close($con);		
	?> 
              <center> <h2> <a class="btn btn-outline-dark" href="ListarFormulario.php">VOLTAR</a> </h2> </center>
